...
public class _03_ProjectTest extends Base {
    ...
    public void validateBookYourTrip() {
        ...
        Assert.assertEquals(project3Page.PassengerType1.getAttribute("value"), "Adult (16-64)");
    ...
    public void validateTest4() {
        ...
        project3Page.dateOfDeparture.sendKeys("18");
        project3Page.dateOfReturn.sendKeys("25");
        project3Page.bookButton.click();
        Waiter.pause(3);
    ...
    public void validateTest5(){
        ...
        DropdownHandler.clickDropdownOption(project3Page.PassengerType1,OptionPassengerType,"Adult (16-64)");
        List<WebElement>OptionPassengerType2= driver.findElements(By.cssSelector("form>div>div:nth-child(9)>div>select>option"));
        DropdownHandler.clickDropdownOption(project3Page.PassengerType1,OptionPassengerType2,"Child (2-11)");
        project3Page.bookButton.click();
        Waiter.pause(3);
        String [] expectedResults = {"Tue Jun 12 2023","Number of Passengers: 2","Passenger 1: Adult (16-64)","Passenger 2: Child (2-11)","Cabin class: Premium Economy"};
        for (int i = 0; i < project3Page.bookInfo.size(); i++) {
            Assert.assertEquals(project3Page.bookInfo.get(i).getText(),expectedResults[i]);
            System.out.println(project3Page.bookInfo);
        }
